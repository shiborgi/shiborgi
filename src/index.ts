...
import { ensureContainerRuntimeRunning, cleanupOrphans, getAppleBridgeIp, CONTAINER_RUNTIME_BIN } from './container-runtime.js';
...
async function main(): Promise<void> {
  ...
  // 2a. Apple Container: resolve host.docker.internal gateway IP from the
